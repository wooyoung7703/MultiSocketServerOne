...
/* JavaScript content from js/comm/jquery/jquery.touchSlider.js in folder common */
/**
 ...
 *		counter			-	슬라이드 콜백, 카운터
 *		autostart       -   자동슬라이드 유무
 *		autostart_speed -   자동슬라이드 시간
 *		autostart_stop  -   자동슬라이드 오버시 멈춤유무
 *
 * @example
		...
		animate : function (d, btn_click) {						
			if(this._drag || !this._scroll || btn_click) {
				...
				{	
					...
					this._list.fadeOut(2000);
					this._list.eq(this._num).fadeIn(2000);
