...
/* JavaScript content from js/comm/s_code_s_catal.js in folder common */
/* SiteCatalyst code version: H.25.
Copyright 1996-2012 Adobe, Inc. All Rights Reserved
More info available at http://www.omniture.com */

var s_account = (stateDev) ? "lcardlottecardmobileappdev" : "lcardlottecardmobileappprod";
var s_catal=s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s_catal.charSet="UTF-8"
s_catal.cookieDomainPeriods=3
/* Conversion Config */
s_catal.currencyCode="KRW"
/* Link Tracking Config */
s_catal.trackDownloadLinks=true
s_catal.trackExternalLinks=true
s_catal.trackInlineStats=true
s_catal.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s_catal.linkInternalFilters="javascript:,lottecard.co.kr"
s_catal.linkLeaveQueryString=false
s_catal.linkTrackVars="None"
s_catal.linkTrackEvents="None"

function trackClicks(ClickName) {
  s_catal.linkTrackVars="eVar5,events,hier2";
  s_catal.linkTrackEvents="event5";
  s_catal.eVar5=ClickName;
  s_catal.events="event5";
   if(s_catal.eVar5&&!s_catal.hier2) s_catal.hier2=s_catal.eVar5;
s_catal.tl(true,'o','Internal Clicks');
}

function trackClickExit(exitClickName) {
  s_catal.linkTrackVars="eVar6,events,hier3";
  s_catal.linkTrackEvents="event6";
  s_catal.eVar6=exitClickName;
  s_catal.events="event6";
    if(s_catal.eVar6&&!s_catal.hier3) s_catal.hier3=s_catal.eVar6;
s_catal.tl(true,'e','External Clicks');
}

/* Plugin Config */
s_catal.usePlugins=true
function s_doPlugins(s) {

	  /* Custom PageView Event */
	s_catal.events = s_catal.apl(s_catal.events,"event1",",",2);
	s_catal.prop12 = "D=g";
	s_catal.eVar12 = "D=g";
	
	/* Break up Page Name into Hireracy level */
	      if(s_catal.pageName) {
		var valueArray = s_catal.pageName.split(":");
		if(valueArray[0]!=undefined) {
			s_catal.prop1=valueArray[0];		// Category 1depth 
			if(valueArray[1]!=undefined) {
				s_catal.prop2=valueArray[0]+':'+valueArray[1];		// Category 2depth
				if(valueArray[2]!=undefined) {
					s_catal.prop3=valueArray[0]+':'+valueArray[1]+':'+valueArray[2];	// Category 3depth
					if(valueArray[3]!=undefined) {
						s_catal.prop4=valueArray[0]+':'+valueArray[1]+':'+valueArray[2]+':'+valueArray[3];	// Category 4depth
					}
				}
			}
		}
  ...
  if(s_catal.prop1&&!s_catal.eVar1) s_catal.eVar1="D=c1";
  if(s_catal.prop2&&!s_catal.eVar2) s_catal.channel=s_catal.eVar2="D=c2";
  if(s_catal.prop3&&!s_catal.eVar3) s_catal.eVar3="D=c3";
  if(s_catal.prop4&&!s_catal.eVar4) s_catal.eVar4="D=c4";
  if(s_catal.prop7&&!s_catal.eVar7) s_catal.eVar7="D=c7";
  if(s_catal.prop8&&!s_catal.eVar8) s_catal.eVar8="D=c8";
  if(s_catal.prop9&&!s_catal.eVar9) s_catal.eVar9="D=c9";
  if(s_catal.pageName&&!s_catal.hier1) s_catal.hier1=s_catal.pageName;
  
  /* Time Parting */
	s_catal.prop17=s_catal.getTimeParting('h','+9','','0');
	s_catal.prop18=s_catal.getTimeParting('d','+9','','0');
	s_catal.eVar17="D=c17";
	s_catal.eVar18="D=c18";
  /* Campaign tracking code */
  if(!s_catal.campaign) s_catal.campaign=s_catal.getQueryParam('cmpid');
	s_catal.campaign=s_catal.getValOnce(s_catal.campaign,'s_campaign',0);
  /* Login Count */
  if(s_catal.eVar11) {
    var pLogin = s_catal.getPreviousValue(s_catal.eVar11,'s_ev11','');
    if(s_catal.eVar11 == "로그인" &&  pLogin == "비로그인") s_catal.events = s_catal.apl(s_catal.events,"event12",",",2);
    }
}
s_catal.doPlugins=s_doPlugins
/************************** PLUGINS SECTION *************************/
 ...
 */
s_catal.apl=new Function("L","v","d","u",""
 ...
 */
s_catal.split=new Function("l","d",""
+"var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x"
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");
/*
 * s.join: 1.0 - Joins an array into a string
 */
s_catal.join = new Function("v","p",""
 ...
 */
s_catal.repl=new Function("x","o","n",""
+"var i=x.indexOf(o),l=n.length;while(x&&i>=0){x=x.substring(0,i)+n+x."
+"substring(i+o.length);i=x.indexOf(o,i+l)}return x");
/*
 * Plugin: getQueryParam 2.4 - 2011.10
 */
s_catal.getQueryParam=new Function("p","d","u","h",""
+"var s=this,v='',i,j,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.loca"
+"tion);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0"
+"?p.length:i;t=s.p_gpv(p.substring(0,i),u+'',h);if(t){t=t.indexOf('#"
+"')>-1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substrin"
+"g(i==p.length?i:i+1)}return v");
s_catal.p_gpv=new Function("k","u","h",""
+"var s=this,v='',q;j=h==1?'#':'?';i=u.indexOf(j);if(k&&i>-1){q=u.sub"
+"string(i+1);v=s.pt(q,'&','p_gvf',k)}return v");
s_catal.p_gvf=new Function("t","k",""
 ...
 */
s_catal.getValOnce=new Function("v","c","e",""
+"var s=this,k=s.c_r(c),a=new Date;e=e?e:0;if(v){a.setTime(a.getTime("
+")+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v");
/*
 * Utility manageVars v1.4 - clear variable values (requires split 1.5)
 */
s_catal.manageVars=new Function("c","l","f",""
...
s_catal.clearVars=new Function("t","var s=this;s[t]='';");
s_catal.lowercaseVars=new Function("t",""
+"var s=this;if(s[t]&&t!='events'){s[t]=s[t].toString();if(s[t].index"
+"Of('D=')!=0){s[t]=s[t].toLowerCase();}}");
/*
 * Plugin: getTimeParting 2.0 
 */
s_catal.getTimeParting=new Function("t","z","y","l",""
 ...
 */
s_catal.getPreviousValue=new Function("v","c","el",""
...
s_catal.visitorNamespace="lottecard"
s_catal.trackingServer="lottecard.sc.omtrdc.net"
